...
from models.theme import CARD, CARD_BORDER, TEXT_MAIN
...
class CatalogScreen(MDScreen):
    ...
    def open_drug_detail(self, drug_id):
        # Сброс строки поиска: после возврата из карточки каталог
        # снова показывает весь список (пустой text дергает on_search)
